...
token 	= "994710697:AAHNOF9Udk7hND7T043SuxmZWSvDxhhsep4"
bot 	= Bot(token = token)
dp 		= Dispatcher(bot)
...
kb_result = ReplyKeyboardMarkup(resize_keyboard = True, one_time_keyboard = True)
